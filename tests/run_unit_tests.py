...
def test_prune_motion_by_purpose():
    ...
    # default min_motion 0.07 should prune the clip and image, but keep thumbnail if threshold lower
    ...
    print('test_prune_motion_by_purpose passed')
...
def test_persona_basic():
    ...
    print('test_persona_basic passed')


if __name__ == '__main__':
    test_prune_motion_by_purpose()
    test_persona_basic()
